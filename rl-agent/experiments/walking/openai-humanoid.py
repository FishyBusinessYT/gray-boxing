...
class HumanoidEnv(MujocoEnv, utils.EzPickle):
    ...
    def __init__(
        ...
        healthy_z_range: tuple[float, float] = (1.0, 5.0),
        ...
        **kwargs,
        ...
        # Action space should be normalized to [-1, 1] for PPO
    ...
    def step(self, action):
        ...
        # Scale action from [-1, 1] to the actual control range (degrees)
