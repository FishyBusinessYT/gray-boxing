...
def calculate_directions(landmarks):
    nodes = {
        ...
        'l_sh': Vector3(landmarks[12]),
        'l_el': Vector3(landmarks[14]),
        'l_wr': Vector3(landmarks[16]),
        'l_ha': Vector3(landmarks[20]),
        'r_sh': Vector3(landmarks[11]),
        'r_el': Vector3(landmarks[13]),
        'r_wr': Vector3(landmarks[15]),
        'r_ha': Vector3(landmarks[19]),
        'l_hi': Vector3(landmarks[24]),
        'l_kn': Vector3(landmarks[26]),
        'l_an': Vector3(landmarks[28]),
        'l_he': Vector3(landmarks[30]),
        'l_to': Vector3(landmarks[32]),
        'r_hi': Vector3(landmarks[23]),
        'r_kn': Vector3(landmarks[25]),
